const weatherApi = '41fdaa6249246781bd89d1bb3f2ee2d1';
...
function fetchWeatherData(location) {
    const apiUrl = `https://api.openweathermap.org/data/2.5/forecast?q=${location}&appid=${weatherApi}&units=metric`;
        ...
        data => {
            ...
            dayInfoContainer.innerHTML = `
                ...
                <div>
                    ...
                    <span class="title">${todayPrecipitation}</span>
                </div>
                <div>
                    <span class="title">HUMIDITY</span>
                    <span class="title">${todayHumidity}</span>
                </div>
                <div>
                    <span class="title">WIND SPEED</span>
                    <span class="title">${todayWindSpeed}</span>
                </div>
            ...
            alert(`Uncorrect country name: ${error}`);
        });
}
